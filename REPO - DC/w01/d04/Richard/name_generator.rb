...
def rand_first(firstnamelist, lastnamelist)

  first = firstnamelist.shuffle
  last = lastnamelist.shuffle
  puts "Your new awesome name is #{first[0]} #{last[0]}"
end

while true
  puts "Would you like to make a derpy name? (yes or no?)"
  ans = gets.chomp.downcase
  rand_first(firstnamelist, lastnamelist)
  break if ans.include? 'n'
end
