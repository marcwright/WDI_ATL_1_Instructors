describe("JavaScript Functions", function() {
  ...
  // Establish a reference to global scope
  // (this is different between a web browser and NodeJS)
  ...
  describe("scope and closure", function() {
    ...
    it('allows inner scopes to access and modify variables decalred in an outer   scope.', function() {
    ...
    it("allows immediatle-invoked function expressions (IIFE) to create a prive scope for our sweet codez.", function() {
