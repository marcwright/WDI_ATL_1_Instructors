describe("JavaScript Functions", function() {
  ...
  it('will accept arguments and return a value when one is explicitly return', function() {
  ...
  describe('scope and closure', function() {
    ...
    it('will allow function scopes to reference outward, but no look inward at nested closures', function() {
    ...
    it('will overrie conflicting variable declarations in an inner scope. The outer scope will be unaffected.', function() {
    ...
    it('allows immediately-invoked function expressions (IIFE) to create a private scope for our sweet codes.', function() {
  ...
  describe('declaration, assignment, and hoisting', function() {
    ...
    it('will hoist function declarations to the top scope so that they can be used anywhere within that scope.', function() {
    ...
    it('will NOT hoise function assignments to the top of scope, because that will change control flow.', function() {
