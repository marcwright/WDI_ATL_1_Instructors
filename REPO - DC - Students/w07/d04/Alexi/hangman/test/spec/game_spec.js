describe("Hangman", function() {
  ...
  describe("update", function() {
    ...
    it("should render the word display based on the current guesses while the game is actvie", function() {
      game.active = true;
      games.guesses = ['e'];
      game.update();
    ...
    it("should resolve victory as false when all letters are still missing.", function() {
      game.guess = ['s'];
      game.update();
