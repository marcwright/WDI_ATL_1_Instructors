...
describe FortuneCookie do
  ...
  describe "#read" do
    it "tells you to unwrap it if it's still wrapped" do
    ...
    context "when the fortune cookie is unwrapped" do
      ...
      it "tells you to crack it if it's still uncracked" do
        expect(fortune.read).to eq("Crack me!")
      end

      it "reads you a fortune if it's unwrapped and cracked" do
        fortune.crack!
