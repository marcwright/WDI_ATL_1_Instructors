...
(function() {
	...
	function syntaxJs( code ) {
		return code
			...
			.replace(/(@\w+)(\s)/g, "<span class='var'>$1</span>$2")
			.replace(/(^|[\(\){}:\s\.\n])(def|self|new|end|return|if|class|private|super)([\(\){};:\s\.])/g, "$1<span class='kwd'>$2</span>$3") // << keywords
			.replace(/(^|[\(\){}:\s\.\n])(true|false|\d)([\(\){};:\s\.])/g, "$1<span class='dtype'>$2</span>$3"); // << datatypes
	}
