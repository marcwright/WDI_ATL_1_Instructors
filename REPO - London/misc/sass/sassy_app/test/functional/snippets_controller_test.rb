...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { description: @snippet.description, sample: @snippet.sample, title: @snippet.title }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { description: @snippet.description, sample: @snippet.sample, title: @snippet.title }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
