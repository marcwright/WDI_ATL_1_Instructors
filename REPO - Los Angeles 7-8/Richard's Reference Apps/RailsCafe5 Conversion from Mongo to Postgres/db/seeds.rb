...
beans = Bean.create([
  {name: "Cheap Blend", roast: "dark", origin: "Wherever", quantity: "1.0"}, 
...
pastries = Pastry.create([
  {name: "Croisant", dept: "Bakery"}, 
  {name: "Blueberry Muffin", dept: "Bakery"}, 
  {name: "Mango Magic", dept: "Juice"}, 
  {name: "Ham & Cheese Sandwich", dept: "Meals"}  
  ])
